# Scenario definitions based on scenario_definition.md
...
- "reasoning": A brief explanation of why you chose this class based on visual cues (e.g., "The car is stopped at a red light", "The car is turning left at an intersection").
